<template>
  <el-card class="main-card">
    ...
    <div class="operation-container">
      ...
      <el-button type="success" size="small" icon="el-icon-check" @click="listLinks">
        全部
      </el-button>
      <el-button type="warning" size="small" icon="el-icon-check" @click="listLinksUnCheck">
        待审核
      </el-button>
      <!-- 条件筛选 -->
      <div style="margin-left:auto">
        <el-input v-model="keywords" prefix-icon="el-icon-search" size="small" placeholder="请输入友链名" style="width:200px"
    ...
    <el-table border :data="linkList" @selection-change="selectionChange" v-loading="loading">
      ...
      <el-table-column label="操作" align="center" width="160">
        <template slot-scope="scope">
          <el-button type="primary" size="mini" @click="openModel(scope.row)" v-if="scope.row.status != 0">
            编辑
          </el-button>
          <el-button v-else type="success" size="mini" @click="addOrEditCategory(scope.row, 1)">
            通过
          </el-button>
...
export default {
  ...
  methods: {
    ...
    addOrEditCategory(link, type) {
      ...
      console.log("提交参数", this.linkForm);
